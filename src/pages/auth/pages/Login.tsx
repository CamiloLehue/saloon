...
function Login() {
    ...
    return (
        <div className={`grid grid-cols-2 min-h-[600px] px-5 w-full`}>
            <div className="w-full h-full flex flex-col justify-start gap-1  items-center">
                {user.username}
            </div>
            <div className="relative w-full h-full  flex flex-col justify-start gap-1  items-center">
                ...
                <div className="relative h-full w-full flex flex-col justify-center items-center py-10 backdrop-blur-3xl border-t border-t-rose-400/40 rounded-2xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-center flex-col items-center gap-5 scale-94">
                            ...
                            <div>
                                <label>
                                    ¿Aún no tienes cuenta? <Link to="/registrar" className="text-rose-400">¡Registrate aquí!</Link>
                                </label>
                            </div>
                        </div>
