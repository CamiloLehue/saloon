...
import { GrContactInfo, GrInsecure, GrMailOption, GrRotateRight } from "react-icons/gr";
...
function Register() {
    ...
    return (
        <div className={`grid grid-cols-3 min-h-[600px] px-5 w-full`}>
            <div className="relative col-span-2 w-full h-full  flex flex-col justify-start gap-1  items-center">
                <div className="absolute left-0 top w-full h-full -skew-3">
                </div>
                <div className="relative h-full w-full flex flex-col justify-center items-center py-10 backdrop-blur-3xl border-t border-t-rose-400/40 rounded-2xl">
                    <small className="font-bold text-white -skew-3 ">Crea tu cuenta</small>
                    <h3 className="text-4xl mb-10 font-bold text-black/50 -skew-3 ">
                        Para agendar tu hora!
                    </h3>
                    <form onSubmit={handleSubmit}>
                        <section className="grid grid-cols-2 gap-2 scale-94">
                            <div className="group relative w-90 h-40 ">
                              ...
                              -skew-3 group-hover:translate-y-6  group-hover:translate-x-6 transition-all duration-300 ">
                                ...
                                <div className="absolute -skew-2 -top-5 left-5 w-50 h-10 z-1 bg-rose-400 border-2 border-rose-900 flex flex-col justify-center items-center">
                                    <h4 className="text-rose-900 font-bold">Nombre y Apellido</h4>
                                </div>
                                    ...
                                    <div className="grid grid-cols-3 w-full h-full place-items-center">
                                        ...
                                        <div className="w-full col-span-2  pe-5">
                                            <input
                                                name="username"
                                                type="text"
                                                placeholder="Ingrese aquí tu nombre y apellido"
                                                value={username}
                            ...
                            <div className="group relative w-90 h-40 ">
                              ...
                              -skew-3 group-hover:translate-y-6  group-hover:translate-x-6 transition-all duration-300 ">
                                ...
                                <div className="absolute -skew-2 -top-5 left-5 w-50 h-10 z-1 bg-rose-400 border-2 border-rose-900 flex flex-col justify-center items-center">
                                    <h4 className="text-rose-900 font-bold">Correo Electronico</h4>
                                </div>
                                <div className="relative 
                                    bg-rose-400 
                                    border-2 border-rose-900
                                ...
                                >
                                    <div className="grid grid-cols-3 w-full h-full place-items-center">
                                        <div className="w-[calc(100%-2rem)] h-[calc(100%-3rem)] bg-rose-900 p-2 group-hover:translate-y-1  group-hover:translate-x-1 transition-all duration-700 ">
                                            <div className=" h-full w-full bg-rose-300 flex flex-col justify-center items-center group-hover:-translate-y-3.5  group-hover:-translate-x-3.5 transition-all duration-500">
                                                <GrMailOption className="text-rose-900 text-4xl" />
                                            </div>
                                        </div>
                                        <div className="w-full col-span-2  pe-5">
                                            <input
                            ...
                            <div className="group relative w-90 h-40  scale-95 focus:scale-100 ">
                                ...
                                <div className="absolute -skew-2 -top-5 left-5 w-30 h-10 z-1 bg-rose-400 border-2 border-rose-900 flex flex-col justify-center items-center">
                                    <h4 className="text-rose-900 font-bold">Repetir</h4>
                                </div>
                                <div className="relative 
                                bg-rose-400 
                                border-2 border-rose-900
                                ...
                                >
                                    <div className="grid grid-cols-3 w-full h-full place-items-center">
                                        <div className="w-[calc(100%-2rem)] h-[calc(100%-3rem)] bg-rose-900 p-2 group-hover:translate-y-1  group-hover:translate-x-1 transition-all duration-700 ">
                                            <div className=" h-full w-full bg-rose-300 flex flex-col justify-center items-center group-hover:-translate-y-3.5  group-hover:-translate-x-3.5 transition-all duration-500">
                                                <GrRotateRight className="text-rose-900 text-4xl" />
                        ...
                        <div className="flex justify-center flex-col items-center gap-5 scale-94">
                            <label
                                className="relative text-rose-400 flex cursor-pointer items-center justify-center gap-[1em] scale-90"
                                htmlFor="heart"
                            >
                            ...
                            <div>
                                <label>
                                    ¿Ya tienes cuenta? <Link to="/auth" className="text-rose-400">¡Inicia sesión!</Link>
                                </label>
                            </div>
                        </div>
            ...
            <div className="w-full h-full flex flex-col justify-start gap-1  items-center">
                {user.username}
            </div>
